...
def save_to_csv(document_chunks: List[Document], csv_path: str) -> None:
    """
    Saves the document chunks to a CSV file.

    :param document_chunks: A list of Document objects.
    :param csv_path: The path where the CSV file will be saved.
    """
    with open(csv_path, 'w', newline='', encoding='utf-8') as csvfile:
        fieldnames = ['page_number', 'chunk', 'source', 'page_content']
...
if __name__ == "__main__":
    ...
    # Step 2.5: Save to CSV
    csv_path = "processed_pdf.csv"
    save_to_csv(document_chunks, csv_path)
